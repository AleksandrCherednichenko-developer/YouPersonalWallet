...
export class ErrorBoundary extends Component<Props, State> {
	...
	render() {
		if (this.state.hasError) {
			...
			return (
				<div className='min-h-screen bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#0f0f23] flex items-center justify-center'>
					<div className='glass-card p-8 shadow-2xl text-center max-w-md'>
